...
static const uint8_t SYNC_CONFIG = (1 << 5) | (1 << 4) | (2 - 1);
...
void SX1276::setup() {
  ...
  this->spi_write(0x27, {SYNC_CONFIG, 0x54, 0x3D});
...
void SX1276::restart_rx() {
  ...
  // Pełna konfiguracja sync word - od rejestru 0x27
  this->spi_write(0x27, {SYNC_CONFIG, 0x54, sync2});
